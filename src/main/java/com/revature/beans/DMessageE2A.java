...
@Entity
@Table (name = "dmessage_e2a")
public class DMessageE2A {
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DMessageE2A other = (DMessageE2A) obj;
		if (author == null) {
	...
	public String toString() {
		return "DMessageE2A [id=" + id + ", draftMessage=" + draftMessage + ", author=" + author + ", editor=" + editor
				+ "]";
	}
