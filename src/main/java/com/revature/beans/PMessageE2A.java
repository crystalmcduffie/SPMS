...
@Entity
@Table (name = "pmessage_e2a")
public class PMessageE2A {
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PMessageE2A other = (PMessageE2A) obj;
		if (author == null) {
	...
	public String toString() {
		return "PMessageE2A [id=" + id + ", pitchMessage=" + pitchMessage + ", author=" + author + ", editor=" + editor
				+ "]";
	}
