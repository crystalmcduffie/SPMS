...
@Entity
@Table (name = "dchange_a2e")
public class DChangeA2E {
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DChangeA2E other = (DChangeA2E) obj;
		if (author == null) {
	...
	public String toString() {
		return "DChangeA2E [id=" + id + ", draftChange=" + draftChange + ", author=" + author + ", editor=" + editor
				+ "]";
	}
