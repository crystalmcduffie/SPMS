...
@Entity
@Table (name = "p_review_e2a")
public class PReviewE2A {
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PReviewE2A other = (PReviewE2A) obj;
		if (author == null) {
	...
	public String toString() {
		return "PReviewE2A [id=" + id + ", pitchReview=" + pitchReview + ", author=" + author + ", editor=" + editor
				+ "]";
	}
}
